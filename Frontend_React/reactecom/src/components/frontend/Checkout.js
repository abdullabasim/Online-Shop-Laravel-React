...
import  ReactDOM  from "Frontend_React-dom";
import React, { useEffect, useState } from "react";
import { useHistory } from "Frontend_React-router-dom";
...
function Checkout(){
    ...
    const PayPalButton= window.paypal.Button.driver('Frontend_React',{React,ReactDOM});
